...
###########################################################################
#------------Сам процесс Becap  с подсчетом времени выполнения---------------
...
Min=$(( $(( $DT_TOTAL-$Chas*3600 ))/60 ))
# Получение секунд из разницы
Sek=$(( $DT_TOTAL-$(( $Chas*3600+$Min*60 )) ))
echo "Общее время выполнения: $Chas часов $Min минут $Sek секунд">>./$bacdir/readme.txt
